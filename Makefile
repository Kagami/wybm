...
DIST_DIR = dist
LIN64_NW_DIR = bin/nwjs-v0.13.0-beta5-linux-x64
...
WIN32_NW_DIR = bin/nwjs-v0.13.0-beta5-win-ia32
...
# Appending zip to the executable is not supported in 0.13 yet.
# See <https://github.com/nwjs/nw.js/issues/4071>.
